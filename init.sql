create table IF NOT EXISTS  public.places (
    ...
    pet_size integer null,
    friendly_level integer null,
    additional_info jsonb null,
    created_at timestamp with time zone null default current_timestamp,
    updated_at timestamp with time zone null default current_timestamp,
    adname character varying(64) null,
    city_name character varying(64) null,
    business_area character varying(64) null,
    tel character varying(64) null,
    entr_location character varying(64) null,
    biz_ext json null,
